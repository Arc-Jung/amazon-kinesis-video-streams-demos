...
STATUS createCanaryStreamCallbacks(Aws::CloudWatch::CloudWatchClient* cwClient,
                                   PCHAR pStreamName,
                                   PStreamCallbacks* ppStreamCallbacks, PCanaryStreamCallbacks* ppCanaryStreamCallbacks)
{
    ENTERS();
    ...
    pCanaryStreamCallbacks->bufferedAckDatum.SetMetricName("BufferedAckLatency");
                                      ...
                                      PFragmentAck pFragmentAck)
{
    ...
    case FRAGMENT_ACK_TYPE_BUFFERING:
            pCanaryStreamCallbacks->bufferedAckDatum.SetValue((GETTIME() - timeOfFragmentEndSent) / HUNDREDS_OF_NANOS_IN_A_MILLISECOND);
            pCanaryStreamCallbacks->bufferedAckDatum.SetUnit(Aws::CloudWatch::Model::StandardUnit::Milliseconds);
